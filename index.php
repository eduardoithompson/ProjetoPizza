...
<LINK REL="SHORTCUT ICON" HREF="assets/img/pizza.png">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top"  style="font-family:'Arial, sans-serif'; font-weight: bold; font-size: 12px; color:white;">
    ...
    <a class="navbar-brand" href="#">
      <img src="assets/img/pizza.png" width="30" height="30" class="d-inline-block align-top" alt="">
...
<body>
    <!-- <div class="Content-outer" id="yui_3_17_2_1_1581360672814_69"> -->
      ...
      <!-- </div> -->
    <!-- <article class="Index-gallery-item" id="pizza1">
    ...
    <!-- <figure class="Index-gallery-item-image" style="overflow: hidden; float: left;">
  ...
  <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img class="d-block w-100" src="assets/img/fachada.jpg" alt="Primeiro Slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="assets/img/lo.jpg" alt="Segundo Slide">
      </div>
      <div class="carousel-item">
        <img class="d-block w-100" src="assets/img/lo2.jpg" alt="Terceiro Slide">
      </div>
    </div>
  ...
  <!-- <div class="footer" style=" width: auto; height: 70px; margin-top: 100px;">
    <div style="float: left; width:400px;">
      ...
      <img style="float:left; margin-top: 140px; margin-left: -110px;" src="assets/img/facebook.jpg" width="60" height="30" class="d-inline-block align-top" alt="" style="float:left">
      <img style="float:left; margin-top: 140px; margin-left: -50px;" src="assets/img/instagram.png" width="30" height="30" class="d-inline-block align-top" alt="" style="float:left">
...
<div class="Index-page-content " id="yui_3_17_2_1_1582853149157_67">
    <div style="margin-left:100px;margin-top:200px;float:left;" class="sqs-layout sqs-grid-12 columns-12">
        <img src="assets/img/apaixonados.png">
    </div>
    <div  id="texto" style="font-family: proxima-nova;  float:left; width:800px; margin-left:500px; margin-top:-100px;" class="sqs-block-content">
            <p>Ingredientes garimpados, receitas inspiradas, hospitalidade em cada
                ...
                uma pizzaria apaixonada por pizza, como você.</p>
    </div>
</div>
  ...
  <!-- <div class="container">
  <div class="mt-5"> -->
  <div class="card mb-4" style="max-width: 2000px; margin-top:100px; width: 1000px; float:left;">
    ...
    <div class="col-md-8">
        <div class="card-body">
          ...
          Desde 1971 a Pizzaria do Angelo, está localizada em um dos principais bairros de São Paulo, com muito orgulho em fazer parte do coração da Mooca, levamos como principal conceito, a satisfação dos nossos clientes e também aquela interação diferenciada e duradoura.<br><br>
  
  E para você que almeja estar em um ambiente tradicional e familiar e admira uma bela pizza,. Venha conhecer à Pizzaria do Angelo, que tem como opção de atendimento, o nosso salão ou o famoso balcão de Pizzas da Mooca. Aguardamos por você e sua família.<br>
            </div>
        </div>
      </div>
      <div class="col-md-4" id="legopizza">
        <img src="assets\img\historia.jpg" class="card-img" alt="...">
      </div>
    <!-- </div>
  </div> -->
  <!-- </section> -->
  ...
  <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1cF_l5GbkdOGVqtbSW9ZkQg-EDfezt2iH" width="640" height="480"></iframe>
